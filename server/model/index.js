...
function createData() {
    ...
    comments.push({_id:commentIds[0],title:'这是我的第一篇文章',summary:'这是划时代意义的第一篇文章',author:'trj',date:'2017-9-4',content:'大家好啊，这是我的第一篇化时代意义的文章，有问题大家尽管来问我~',review:[reviewIds[0],reviewIds[1]]});
    reviews.push({_id:reviewIds[0],content:'你好，这是我的第一条评论哦.',date:'2017-9-4',comment:commentIds[0]});
    reviews.push({_id:reviewIds[1],content:'你好，这是我的第二条评论哦.',date:'2017-9-4',comment:commentIds[0]});
